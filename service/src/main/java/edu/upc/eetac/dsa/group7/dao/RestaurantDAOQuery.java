...
public interface RestaurantDAOQuery {
    ...
    public final static String GET_RESTAURANTS = "select hex(id) as id, hex(owner) as owner, name, description, avgprice, likes, address, phone, lat, lng from restaurants ORDER BY likes ASC";
